...
def demo_normalization():
    ...
    for amount, unit in test_cases:
        normalized, _, estimated = normalizer.parse_amount_with_unit(amount)
        print(f"标准化: {normalized} {normalizer.get_comparable_value(normalized, unit)}")
        print(f"显示: {normalizer.format_for_display(normalized, unit)}")
